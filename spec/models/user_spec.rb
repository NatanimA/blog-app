...
RSpec.describe User, type: :model do
  subject { User.new(name: "Natanim Abesha",photo: "https://www.pexels.com/photo/abandoned-ancient-antique-architecture-235986/", bio: "Neo is an Ethiopian app developer cum reality TV star, television personality, entrepreneur, and entertainer. He is known for being one of the housemates of the season 5 Lockdown edition of the popular Nigerian reality TV show named Big Brother Naija premiered in 2020." ,
    posts_counter: 0) }
