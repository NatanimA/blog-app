...
RSpec.describe Post, type: :model do
  subject { Post.new(title: "How I became self taught programmer.",text:"This is how I became the most amazing developer in history",comments_counter: 0 ,likes_counter:0 ,author_id:1)}
